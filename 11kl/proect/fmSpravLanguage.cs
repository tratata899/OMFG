...
namespace proect
{
    public  class fmSpravLanguage: Form
    {
        ...
        private void RefreshData()
        {
            ...
            string sql =
                " SELECT " +
                "   LANGUAGE_RECID as [Код], " +
                "   LANGUAGE_NAME as [Название] " +
                " FROM " +
                "   SPRAV_LANGUAGE " +
                " ";
            ...
            da.Fill(ds, "SPRAV_LANGUAGE");
            dataGridView1.DataSource = ds.Tables["SPRAV_LANGUAGE"].DefaultView;
            connection.Close();
        }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            string sql =
                    " DELETE * " +
                    " FROM  SPRAV_LANGUAGE " +
                    " WHERE LANGUAGE_RECID = " + CurrentId.ToString() +
                    "  ";
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            if (state == 2)
            {
                string sql =
                    ...
                    "   SPRAV_LANGUAGE " +
                    " SET " +
                    "   LANGUAGE_NAME = '" + tbName.Text + "' " +
                    " WHERE " +
                    "   LANGUAGE_RECID = " + CurrentId.ToString() +
                    "  ";
                OleDbCommand dc = new OleDbCommand(sql, connection);
                connection.Open();
                OleDbDataReader or = dc.ExecuteReader();
